    ...
    <>
      <div className="col-span-8">
          ...
          <div className="p-2 flex flex-col">
            ...
            <div className="rounded-sm space-y-2">
              {options.map((option) => (
                <label
                  key={option.id}
                  className="flex items-center justify-between bg-zinc-800 text-gray-300 px-2 py-2 rounded-sm cursor-pointer hover:bg-zinc-700"
                >
        ...
        <div className="flex flex-row w-full justify-center p-2 gap-2">
          <button className="border border-yellow-400 text-yellow-400 rounded-sm px-6 py-2 hover:text-black hover:bg-yellow-400">
            입금신청하기
          </button>
          <button className="bg-zinc-700 px-6 py-2 hover:bg-zinc-500 rounded-sm">
            입금신청하기
          </button>
        </div>{" "}
