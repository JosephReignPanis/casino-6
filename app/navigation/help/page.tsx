...
export default function Home() {
  return (
    <>
      ...
      <div className="flex flex-col gap-2 md:hidden rounded-sm">
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="bg-neutral-900 p-4 rounded-sm border border-neutral-800 text-white"
          >
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full bg-neutral-900 table-auto rounded-sm">
          <thead>
            <tr>
